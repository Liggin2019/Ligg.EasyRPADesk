...
namespace Ligg.WinForm.Controls
{
    public partial class ListViewEx : UserControl
    {
        ...
        //#constructor
        public ListViewEx(string headerCfgXmPath, string contentMenuCfgXmPath)
        {
            try
            {
        ...
        public int RowHeight
        {
            set
            {
                ...
                smalImageList.ImageSize = new Size(1, value);
            }
        }
        ...
        private void ListViewEx_Load(object sender, EventArgs e)
        {
            ...
            listView.SmallImageList = smalImageList;
        ...
        private void listView_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var args = new ListViewExColumnClickEventArgs(listView.Columns[e.Column].Name, _isOrderDescending);
        ...
        public void InitComponent(string headerCfgXmPath, string contentMenuCfgXmPath)
        {
            try
            {
                ...
                if (File.Exists(contentMenuCfgXmPath))
                {
                    ...
                    {
                        contentMenuItem.Type = EnumHelper.GetIdByName<ListViewExContextMenuItemType>(contentMenuItem.TypeName);
                    }
    ...
    public class ListViewExColumnClickEventArgs : EventArgs
    {
        public ListViewExColumnClickEventArgs(string columnName, bool isDescending)
        {
    ...
    public enum ListViewExContextMenuItemType
    {
        SelectNone = 10,
        SelectOne = 11,
        SelectMany = 12,
