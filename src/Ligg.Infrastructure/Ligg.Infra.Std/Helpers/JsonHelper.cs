...
namespace Ligg.Infrastructure.Helpers
{
    public static class JsonHelper
    {
        ...
        public static T ConvertToGeneric<T>(string jsonStr, string dateTimeFormat = "")
        {
            try
            {
        ...
        public static DataTable ConvertToDataTable(string jsonStr, string dateTimeFormat = "")
        {
            try
            {
                return Deserialize<DataTable>(jsonStr, dateTimeFormat);
            }
            catch (Exception ex)
            {
                throw new ArgumentException(_typeFullName + ".ConvertToDataTable Error: " + ex.Message);
            }
        }
