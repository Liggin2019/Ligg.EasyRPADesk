...
using Ligg.Infrastructure.Base.Resources;
...
namespace Ligg.Infrastructure.Base.Helpers
{
    public static class SystemTimeHelper
    {
        ...
        public static string GetTimeSpanString(double milliSeconds,string accuracyFlag,bool isByCulture)
        {
            ...
            {
                var timeFlag = isByCulture ? BaseRes.Days : " Days";
            ...
            {
                var timeFlag = isByCulture ? BaseRes.Hours : " Hours";
            ...
            {
                var timeFlag = isByCulture ? BaseRes.Minutes : " Mins";
            ...
            {
                var timeFlag = isByCulture ? BaseRes.Seconds : " Secs";
            ...
            {
                var timeFlag = isByCulture ? BaseRes.MilliSeconds : " MilliSecs";
